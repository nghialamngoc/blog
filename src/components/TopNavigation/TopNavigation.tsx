...
export const TopNavigation: FC<TopNavigation> = ({ categories, className }) => {
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  {
                    'bg-accent dark:text-white font-medium pointer-events-none': categoryParam === category.value,
                  },
                )}
              >
                {category.label}
